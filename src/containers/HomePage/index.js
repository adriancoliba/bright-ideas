...
class HomePage extends Component {
  ...
  render() {
    ...
    if (this.state.loading) return <BounceLoaderComponent loading={this.state.loading}/>;
          ...
          <Container component="main" maxWidth={'lg'}>
            ...
            <div>
              ...
              <Grid container alignItems={'center'} justify={'flex-end'}>
                <Grid item>
                  <Typography variant="h4" className={classes.youNeedToSignIn}>You need to be signed in to create
                    and share notes &nbsp;</Typography>
                </Grid>
                <Grid item>
